...
export class SidebarComponent {
  ...
  readonly sidebarItems: SidebarItem[] = [
    ...
    { label: 'Master', route: '/dashboard/master', icon: 'pip', pageKey: 'dashboard/master/menu' },
    ...
    { label: 'ECN', route: '/dashboard/ecn', icon: 'explicit', pageKey: 'dashboard/ecn' },
    { label: 'Labels', route: '/dashboard/label', icon: 'dynamic_feed', pageKey: 'dashboard/label' },
